...
export default function DropdownMenu() {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      >
        <MenuItems className="absolute right-0 z-10 mt-2 origin-top-right rounded-md border border-zinc-400 dark:border-zinc-700 bg-orange-50 dark:bg-zinc-800 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none divide-y divide-zinc-400 dark:divide-zinc-700">
          <div className="py-1">
            <MenuItem>
              <a
                href="/"
                className="block px-4 py-2 text-sm uppercase font-bold no-underline data-[focus]:bg-orange-200 dark:data-[focus]:bg-zinc-700"
              >
                Home
              </a>
            </MenuItem>

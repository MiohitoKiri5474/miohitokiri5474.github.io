...
其實在一開始高中準備換筆電的時候是沒有考慮 Macbook 的，因為相較於其他同規格筆電 Mac 的價格總是高上其他廠商一大截
...
還有 iDevice 祖傳的方便轉換設備，換新機的時候可以直接把兩台設備丟在同一個網路下（或是預算比較充足的買條 Thunderbolt 線連接）就能自動轉移
...
> Update 2026/06/12
> 當時的我沒想到，在 2025 年底記憶體/SSD 價格大漲後，Apple 在這種時間點不但上調了最低版本的儲存空間，還下調了 SSD 容量升級價格
> Apple 成功的從 `升級搶錢` 變成了 `佛心公司`，這一點是我從來都沒有想到到的
